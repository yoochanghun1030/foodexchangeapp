// app/food/create/CreateFoodInner.tsx
"use client";
...
export default function CreateFoodInner() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            setTitle(''); setCategory(''); setNutrition(''); setImageUrl('')
            setQuantity(1); setUnit('pcs'); setFile(null); setFilePreview('')
        } catch {
    ...
    return (
        <div style={{ padding: 20, maxWidth: 700, margin: '0 auto' }}>
            ...
            <button
                onClick={() => window.open('https://world.openfoodfacts.org', '_blank')}
                style={{ marginLeft: 10 }}
            >
                OpenFoodFacts
            </button>
