...
public class FoodItemService {
    ...
    private FoodItem toEntity(
        ...
        if (StringUtils.hasText(dto.getAvailableFrom())) {
            from = LocalDateTime.parse(dto.getAvailableFrom());
        }
        LocalDateTime until = null;
        if (StringUtils.hasText(dto.getAvailableUntil())) {
            until = LocalDateTime.parse(dto.getAvailableUntil());
        }
